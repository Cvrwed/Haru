...
public class PostUpdateEvent extends Event {
    ...
    /**
     * Constructs a new PostUpdateEvent object with the specified player position and orientation values.
     *
     ...
     */
    public PostUpdateEvent(double x, double y, double z, float yaw, float pitch, boolean onGround) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.yaw = yaw;
