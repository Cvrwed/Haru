...
public class Fixes extends Module {
	...
	public Fixes() {
		...
		this.registerSetting(noClickDelay, noJumpDelay, noC15, noRender);
		this.withEnabled(true, Fixes.class);
	}
    ...
    public static boolean shouldStopRender(Entity entity) {
        return (entity instanceof EntityBoat || entity instanceof EntityMinecart || entity instanceof EntityItemFrame || entity instanceof EntityTNTPrimed || entity instanceof EntityArmorStand || entity instanceof EntityArrow) && entity != mc.thePlayer && mc.thePlayer.getDistanceToEntity(entity) > 45.0f;
    }
