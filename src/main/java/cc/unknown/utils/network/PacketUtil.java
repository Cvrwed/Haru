...
public class PacketUtil implements Loona {
	...
	public static boolean packet(Packet<?> packet) {
		return Haru.instance.getModuleManager().x != null && packets(packet) ? Haru.instance.getModuleManager().x.isEnabled() : false;
	}
    ...
    public static void blocking(boolean c, boolean place) {
    ...
    public static void releaseUseItem(boolean c) {
